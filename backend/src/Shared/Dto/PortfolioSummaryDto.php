...
final class PortfolioSummaryDto
{
    public function __construct(
        ...
        public readonly float $totalNetValue,
        public readonly float $totalNetProfitEuro,
        public readonly float $totalNetRoiPercent,
    ...
    public function toArray(): array
    {
        return [
            ...
            'totalNetProfitEuro' => $this->totalNetProfitEuro,
            'totalNetRoiPercent' => $this->totalNetRoiPercent,
