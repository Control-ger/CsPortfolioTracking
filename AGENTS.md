...
| VAC ban stats + ban-wave feed entries | Server cron only (`sync-ban-stats.php`, hourly) — CS2 source (csstats.gg) preferred; all-Steam (vac-ban.com) as fallback trigger + corroboration | Web + Desktop |
