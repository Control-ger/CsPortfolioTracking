...
export default function CsUpdatesPage({ useExternalDesktopSidebarShell = false }) {
  ...
  return (
    <div
      ...
      } bg-background px-3.5 pb-[calc(1.5rem+env(safe-area-inset-bottom))] pt-[max(0.35rem,env(safe-area-inset-top))] font-sans text-foreground sm:p-6 md:p-8 md:pb-0 lg:p-0`}
    >
