  ...
  return (
    <button
      ...
      className={cn(
        ...
        isGainer
          ? "border-success/30 bg-transparent hover:bg-success/7 dark:bg-success/7 dark:hover:bg-success/15"
          : "border-danger/30 bg-transparent hover:bg-danger/7 dark:bg-danger/7 dark:hover:bg-danger/10"
      )}
    >
      ...
      <div className="flex flex-shrink-0 items-center gap-2">
        <div className="flex flex-col items-end gap-0.5">
          <Icon className={cn("h-4 w-4", isGainer ? "text-success" : "text-danger")} />
          <span className={cn("text-xs font-semibold", isGainer ? "text-success" : "text-danger")}>
