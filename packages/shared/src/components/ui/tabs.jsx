...
const TabsList = forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex items-center justify-start border-b border-border/70 w-full bg-transparent px-0",
      className,
    )}
    {...props}
  />
