 ...
 *
 * Extracted from `DesktopSidebarRail` when the mobile drawer needed the same
 * bell. It is the app's only channel for update availability and sync actions
 * (see AGENTS.md), so a second hand-copied implementation would be a place for
 * that contract to drift — the page-local rail copy in `PortfolioPage` is
 * already one such copy too many.
 */
...
export function NotificationBell({
  ...
  useEffect(() => {
    ...
    // A download already running when the bell mounts must still show up.
