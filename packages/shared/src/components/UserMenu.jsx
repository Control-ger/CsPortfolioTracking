    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {sessionUnhealthy && (
            <span className="absolute -bottom-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-card bg-warning-solid text-card">
      ...
      >
        {sessionUnhealthy && (
          <>
            <div className="flex gap-2 rounded-xl bg-warning/10 px-2 py-2 text-warning">
