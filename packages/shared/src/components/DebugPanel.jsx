        ...
        <TabsContent value="csfloat" className="space-y-4">
          ...
          {appLogCount > 0 ? (
            <Card>
              ...
              <CardContent>
                <div className="max-h-96 space-y-1 overflow-auto rounded border bg-muted p-3 font-mono text-xs text-success">
          ...
          {proxyLogCount > 0 ? (
            <Card>
              ...
              <CardContent>
                <div className="max-h-96 space-y-1 overflow-auto rounded border bg-muted p-3 font-mono text-xs text-info">
